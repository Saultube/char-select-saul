...
static const Vtx coin_seg3_vertex_030056C0[] = {
    {{{   -48,      0,      0}, 0, {     0,   1984}, {0xb2, 0xcc, 0x66, 0xff}}},
    {{{    48,      0,      0}, 0, {  1984,   1984}, {0xb2, 0xcc, 0x66, 0xff}}},
    {{{    48,     72,      0}, 0, {  1984,      0}, {0xb2, 0xcc, 0x66, 0xff}}},
    {{{   -48,     72,      0}, 0, {     0,      0}, {0xb2, 0xcc, 0x66, 0xff}}},
};

// 0x03005700
static const Vtx coin_seg3_vertex_03005700[] = {
    {{{   -64,      0,      0}, 0, {     0,   1984}, {0x78, 0x78, 0xff, 0xff}}},
    {{{    64,      0,      0}, 0, {  1984,   1984}, {0x78, 0x78, 0xff, 0xff}}},
    {{{    64,    128,      0}, 0, {  1984,      0}, {0x78, 0x78, 0xff, 0xff}}},
    {{{   -64,    128,      0}, 0, {     0,      0}, {0x78, 0x78, 0xff, 0xff}}},
};

// 0x03005740
static const Vtx coin_seg3_vertex_03005740[] = {
    {{{   -64,      0,      0}, 0, {     0,   1984}, {0x65, 0x00, 0x00, 0xff}}},
    {{{    64,      0,      0}, 0, {  1984,   1984}, {0x65, 0x00, 0x00, 0xff}}},
    {{{    64,     128,     0}, 0, {  1984,      0}, {0x65, 0x00, 0x00, 0xff}}},
    {{{   -64,     128,     0}, 0, {     0,      0}, {0x65, 0x00, 0x00, 0xff}}},
};

// 0x03005780
ALIGNED8 static const Texture coin_seg3_texture_03005780[] = {
#include "actors/saulcoin/coin_front.ia8.inc.c"
};

// 0x03005F80
ALIGNED8 static const Texture coin_seg3_texture_03005F80[] = {
#include "actors/saulcoin/coin_tilt_right.ia8.inc.c"
};

// 0x03006780
ALIGNED8 static const Texture coin_seg3_texture_03006780[] = {
#include "actors/saulcoin/coin_side.ia8.inc.c"
};

// 0x03006F80
ALIGNED8 static const Texture coin_seg3_texture_03006F80[] = {
#include "actors/saulcoin/coin_tilt_left.ia8.inc.c"
};
